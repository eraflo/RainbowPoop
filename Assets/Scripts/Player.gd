...
func _update_weight() -> void:
	_update_modifier_from_source(weight, _sugar, _sugar.value)
	_update_modifier_from_source(weight, _protein, _protein.value)
	_update_modifier_from_source(weight, _fat, _fat.value)
